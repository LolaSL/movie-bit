...
const TermsOfUse = () => {
  return (
    <div className="container">
      ...
      <p>
        Please read these terms of use and conditions carefully before using Our
        Service.
      </p>
      ...
      <h3>Definitions</h3>
      <p>For the purposes of these Terms of Use and Conditions:</p>
      <ul>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to MOVIE-BIT .
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Terms of Use and Conditions</strong> (also referred as
            &quot;Terms&quot;) mean these Terms of Use and Conditions that form the
        ...
        <li>
          <p>
            <strong>Website</strong> refers to MOVIE-BIT , accessible from{" "}
            <a href="https://movie-bit.netlify.app">
      ...
      <p>
        These are the Terms of Use and Conditions governing the use of this Service and
        the agreement that operates between You and the Company. These Terms of Use and
        Conditions set out the rights and obligations of all users regarding the
        use of the Service.
      </p>
      <p>
        Your access to and use of the Service is conditioned on Your acceptance
        of and compliance with these Terms of Use and Conditions. These Terms of Use and
        Conditions apply to all visitors, users and others who access or use the
        Service.
      </p>
      <p>
        By accessing or using the Service You agree to be bound by these Terms of Use
        and Conditions. If You disagree with any part of these Terms of Use and
      ...
      <p>
        We strongly advise You to read the Terms of Use and Conditions and Privacy
      ...
      <p>
        ...
        limitation if You breach these Terms of Use and Conditions.
      </p>
      <p>
      ...
      <p>
        ...
        Terms of Use and Your exclusive remedy for all of the foregoing shall be
      ...
      <p>
        ...
        this Terms of Use), even if the Company or any supplier has been advised of the
      ...
      <p>
        ...
        each party liability will be limited to the greatest extent permitted by
        law.
      </p>
      ...
      <p>
        ...
        company provider makes any representation or warranty of any kind,
      ...
      <p>
        ...
        govern this Terms of Use and Your use of the Service. Your use of the
      ...
      <h3>Severability</h3>
      <p>
        If any provision of these Terms of Use is held to be unenforceable or invalid,
      ...
      <p>
        ...
        performance of an obligation under these Terms of Use shall not effect a party
      ...
      <p>
        These Terms of Use and Conditions may have been translated if We have made them
        available to You on our Service. You agree that the original English
        text shall prevail in the case of a dispute.
      </p>
      <h3>Changes to These Terms of Use and Conditions</h3>
      <p>
      ...
      <h3>Contact Us</h3>
      <p>
        If you have any questions about these Terms of Use and Conditions, You can
        contact us:
      </p>
      <p>
          <a href="&#109;&#097;&#105;&#108;&#116;&#111;&#058;&#109;.&#111;&#46;v.i&#46;e.&#98;&#46;i.t&#46;de&#109;o&#64;&#103;&#109;ail.com">
            m&#46;o&#46;v&#46;i.&#101;.&#98;&#46;i.&#116;.&#100;&#101;&#109;&#111;&#64;gm&#97;il&#46;&#99;&#111;m
          </a>
        </p>
