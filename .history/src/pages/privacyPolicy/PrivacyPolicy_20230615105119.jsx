    ...
    <div className="container">
      ...
      <h2>
        <p>
          ...
          <a href="https://movie-bit.netlify.app">movie-bit.netlify.app</a>{" "}
          website (&#8220;Website&#8221;), &#8220;MOVIE-BIT&#8221; mobile
          application (&#8220;Mobile Application&#8221;), and any of their
        ...
        <p>
          ...
          Website operator and Mobile Application developer
          (&#8220;Operator&#8221;, &#8220;we&#8221;, &#8220;us&#8221; or
        ...
        <h4 id="privacy-of-children">Privacy of children</h4>
        <p>
          ...
          request that we delete that child&#8217;s Personal Information from
          our Services.
        </p>
        <p>
        ...
        <h4 id="use-and-processing-of-collected-information">
          Use and processing of collected information
        </h4>
        <p>
        ...
        <p>
          ...
          help us run and operate the Services.
        </p>
        <p>
        ...
        <h4 id="disclosure-of-information">Disclosure of information</h4>
        <p>
          ...
          rely upon to assist in the operation of the Services available to you
        ...
        <h4 id="retention-of-information">Retention of information</h4>
        <p>
        ...
        <p>
          ...
          or to learn more about the choices available to you
        </p>
        <h4 id="social-media-features">Social media features</h4>
        <p>
          Our Services may include social media features, such as the Facebook
          and Twitter buttons, Share This buttons, etc (collectively,
          &#8220;Social Media Features&#8221;). These Social Media Features may
          collect your IP address, what page you are visiting on our Services,
          and may set a cookie to enable Social Media Features to function
          properly. Social Media Features are hosted either by their respective
          providers or directly on our Services. Your interactions with these
        ...
        <p>
          ...
          been compromised or Users&#8217; Personal Information has been
          ...
          by law. When we do, we will post a notice on the Services.
        </p>
        ...
        <p>
          ...
          Services at any time at our discretion. When we do, we will post a
          notification within the Services. We may also provide notice to you in
        ...
        <h4 id="acceptance-of-this-policy">Acceptance of this policy</h4>
        <p>
          ...
          created with the help of WebsitePolicies.
        </p>
