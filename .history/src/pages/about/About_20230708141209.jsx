    ...
    <div className="heroBanner" data-testid="about-1">
      ...
      <div className="container">
        ...
        <h2>
          ...
          MOVIE-BIT keeps the Top Cast of actors, official videos, similar movies, recommended movies, movies, movie details; a list of movies and tv-shows with the selection by genres and sorting by many options such as title, release, popularity and rating.
