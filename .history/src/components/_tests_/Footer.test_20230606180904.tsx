...
// Assuming you have a context provider component defined as FooterContextProvider
...
import { FaLinkedin, FaGithub } from "react-icons/fa";
import Footer from "../footer/Footer";
import { FooterContextProvider } from "../footer/FooterContext"; // Import the FooterContextProvider

describe("Footer Component", () => {
  test("renders Footer component correctly", () => {
    render(
      <FooterContextProvider> {/* Wrap the component with the context provider */}
        <Footer />
